...
msys 'pacman -S --needed --noconfirm git bison flex make diffutils \
    ucrt64/mingw-w64-ucrt-x86_64-{ccache,docbook-xml,gcc,icu,libbacktrace,libxml2,libxslt,lz4,make,meson,perl,pkg-config,python-cryptography,python-pytest,zlib}' ;
