...
curl.exe -fsSL -o "$filepath" `
    https://github.com/StrawberryPerl/Perl-Dist-Strawberry/releases/download/SP_${perl_version_wo_dots}_64bit_UCRT/strawberry-perl-${perl_version}-64bit-portable.zip
if (!$?) { throw 'cmdfail' }
